...
const VoicePlayer = ({ text, lang }) => {
  ...
  return (
    <GlassmorphicCard style={styles.container} blurAmount={5}>
      <Image
        ...
        <View style={{ flexDirection: 'row', alignItems: 'center', gap: 10 }}>
          {playing ? (
            <TouchableOpacity onPress={stop}>
              <Icon name="pause" size={25} color={theme.primary} />
            </TouchableOpacity>
          ) : (
            <TouchableOpacity onPress={speak}>
              <Entypo name="controller-play" size={25} color={theme.primary} />
            </TouchableOpacity>
          )}
        </View>
      </View>
