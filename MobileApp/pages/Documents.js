  ...
  return (
    <View style={{ flex: 1, backgroundColor: theme.bg }}>
      ...
      <ScrollView
        ...
        {activeTab === 'MyDocs' ? (
          <GlassmorphicCard style={styles.formCard} blurAmount={5}>
          ...
          <GlassmorphicCard style={styles.translateSection} blurAmount={5}>
            <View style={styles.sectionHeader}>
              <Icon
                name="translate"
                size={20}
            ...
            {translatedText && (
              <GlassmorphicCard style={styles.translatedContainer} blurAmount={8}>
                <View style={styles.sectionHeader}>
                  <Icon
                    name="file-document"
                    size={25}
