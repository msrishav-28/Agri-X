...
const featureCards = [
  ...
  },
  {
    ...
    nav: 'Market',
    color: '#ffedd5', // Orange 100 (Earth tone)
  },
  {
    key: 'schemes',
    ...
    nav: 'Scheme',
    color: '#f1f5f9', // Slate 100 (Neutral)
  },
  {
    key: 'news',
    ...
    nav: 'News',
    color: '#e0f2fe', // Sky 100 (Weather/News)
  },
];
  ...
  if (user) {
    return (
      <View style={theme.container}>
        ...
        />
        {/* Background Gradient Orbs for Glassmorphism Context */}
        <View
          style={{
            position: 'absolute',
            top: -100,
            ...
            width: 300,
            height: 300,
            backgroundColor: theme.primary + '20', // Low opacity Primary Green
            borderRadius: 150,
          }}
        />
        <View
          style={{
            ...
            width: 200,
            height: 200,
            backgroundColor: theme.accent + '15', // Low opacity Amber
            borderRadius: 100,
          }}
        />
        <View
          style={{
            ...
            width: 250,
            height: 250,
            backgroundColor: theme.secondary + '15', // Low opacity Emerald
            borderRadius: 125,
          }}
        />
        ...
        <ScrollView
          ...
          >
            <GlassmorphicCard
              style={{
                backgroundColor: theme.primary + '95', // Deep Forest Green
                flexDirection: 'row',
                alignItems: 'center',
                paddingVertical: 20,
          ...
          >
            <GlassmorphicCard
              style={{
                backgroundColor: theme.secondary + '90', // Emerald Green
                flexDirection: 'column',
                alignItems: 'center',
