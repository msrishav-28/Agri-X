import { ScrollView, StyleSheet, Text, View, ActivityIndicator, TextInput, TouchableOpacity, Image, RefreshControl, FlatList, Linking, StatusBar } from 'react-native';
...
const NewsCard = ({ item }) => {
    ...
    return (
        <TouchableOpacity
            ...
            activeOpacity={0.9}
        >
            <GlassmorphicCard style={styles.newsCard} blurAmount={4}>
                {item.thumbnail && (
                    <Image
                        ...
                        <Dropdown
                            ...
                            renderLeftIcon={() => (
                                <Icon
                                    name="tag"
                                    size={20}
                                    color={categoryFocus ? theme.primary : theme.text3}
                        ...
                        <Dropdown
                            ...
                            renderLeftIcon={() => (
                                <Icon
                                    name="map-pin"
                                    size={20}
                                    color={stateFocus ? theme.primary : theme.text3}
                                    style={styles.iconStyle}
                                />
                            )}
                        />
