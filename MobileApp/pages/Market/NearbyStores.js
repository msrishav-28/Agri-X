...
const NearbyStores = () => {
  ...
  const renderStoreItem = ({ item }) => {
    ...
    return (
      <TouchableOpacity
        ...
        activeOpacity={0.9}
      >
        <GlassmorphicCard style={styles.storeCard} blurAmount={4}>
          <View style={styles.storeBasicInfo}>
            <View style={styles.storeIconContainer}>
              <Icon name={item.image} size={32} color={theme.white} style={styles.storeIcon} />
            </View>
            <View style={styles.storeDetails}>
              ...
              <View style={styles.storeMetrics}>
                <View style={styles.metric}>
                  <Icon name="map-marker" size={14} color={theme.text2} />
          ...
          {isExpanded && (
            <View style={styles.expandedContent}>
              <View style={styles.expandedSection}>
                <Icon name="map-marker" size={18} color={theme.primary} style={styles.expandedIcon} />
                <Text style={styles.expandedText}>{item.address}</Text>
              </View>
              <View style={styles.expandedSection}>
                <Icon name="phone" size={18} color={theme.primary} style={styles.expandedIcon} />
                <Text style={styles.expandedText}>{item.contact}</Text>
              </View>
              <View style={styles.expandedSection}>
                <Icon name="cart" size={18} color={theme.primary} style={styles.expandedIcon} />
                <Text style={styles.expandedText}>Buying: {item.buyingCommodities.join(', ')}</Text>
              </View>
              <View style={styles.expandedSection}>
                <Icon name="tag-multiple" size={18} color={theme.primary} style={styles.expandedIcon} />
                <Text style={styles.expandedText}>Specialized in: {item.specializedIn}</Text>
              </View>
              <View style={styles.expandedSection}>
                <Icon name="cash" size={18} color={theme.primary} style={styles.expandedIcon} />
  ...
  return (
    <View style={styles.container}>
      <GlassmorphicCard style={styles.filterCard} blurAmount={6}>
...
const styles = StyleSheet.create({
  container: {
    flex: 1,
    backgroundColor: 'transparent', // Handled by Market.js
    padding: 16,
  },
  filterCard: {
    padding: 12,
