  ...
  return (
    <View style={{ flex: 1, backgroundColor: theme.bg }}>
      ...
      <View style={styles.topNav}>
        <TouchableOpacity
          ...
          <Image
            ...
            style={{ width: 25, height: 25, tintColor: theme.textInverse }}
          />
        </TouchableOpacity>
      ...
      <ScrollView
        ...
        <GlassmorphicCard style={styles.sectionCard} blurAmount={5}>
        ...
        <GlassmorphicCard style={styles.sectionCard} blurAmount={5}>
          <Text style={styles.sectionTitle}>Social & ID</Text>
          <TextInput
